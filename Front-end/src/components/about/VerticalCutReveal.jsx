// src/components/about/VerticalCutReveal.jsx
    ...
    return (
      <span
        className={cn(
          containerClassName,
          "vcr-container",
          splitBy === "lines" && "vcr-lines"
        )}
        onClick={onClick}
        ref={containerRef}
        {...props}
      >
        <span className="sr-only" style={{ position: "absolute", width: 1, height: 1, padding: 0, margin: -1, overflow: "hidden", clip: "rect(0,0,0,0)", whiteSpace: "nowrap", borderWidth: 0 }}>{text}</span>
